...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Butter Hub BF Premium') then
        makefolder('Butter Hub BF Premium')
    end
    if not _G.Dis and not isfile('Butter Hub BF Premium/'..Name..'.json') then
        writefile('Butter Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Butter Hub BF Premium') and isfile('Butter Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Butter Hub BF Premium/'..Name..'.json'))
...
local win = library:Window("Butter",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
