...
if game.PlaceId == 8065776277 and L_1_ then
	...
	if not isfolder("incap") then
		makefolder("incap")
	end;
	if not isfolder("incap/democfg") then
		makefolder("incap/democfg")
	end;
	function L_177_:saveConfig()
		...
		writefile("incap/democfg/" .. L_614_ .. ".cfg", game:GetService("HttpService"):JSONEncode(L_615_))
		L_177_:refreshConfigs()
	end;
	function L_177_:loadConfig()
		local L_618_ = L_177_.flags["selected_config"]
		if not isfile("incap/democfg/" .. L_618_ .. ".cfg") then
			return
		end;
		local L_619_ = game:GetService("HttpService"):JSONDecode(readfile("incap/democfg/" .. L_618_ .. ".cfg"))
	...
	function L_177_:refreshConfigs()
		local L_622_ = {}
		for L_623_forvar0, L_624_forvar1 in next, listfiles("incap/democfg") do
	...
	function L_177_:deleteConfig()
		if isfile("incap/democfg/" .. L_177_.flags["selected_config"] .. ".cfg") then
			delfile("incap/democfg/" .. L_177_.flags["selected_config"] .. ".cfg")
			L_177_:refreshConfigs()
		end
	end;
	...
	L_174_.wait:Destroy()
	for L_703_forvar0, L_704_forvar1 in pairs(listfiles("incap/demos/")) do
...
function L_5_:Init()
	...
	spawn(function()
		while L_5_ do
			...
			if isfolder("incap/scripts") then
				local L_928_ = {}
				for L_929_forvar0, L_930_forvar1 in next, listfiles("incap/scripts") do
					local L_931_ = L_930_forvar1:match('incap/scripts\\([%w%s%-]*)%.%a?')
...
onKill.Name = "onKill"
if not isfolder("incap/tempimages") then
	makefolder("incap/tempimages")
end;
if not isfolder("incap/demos") then
	makefolder("incap/demos")
end;
local L_61_ = -3846999;
local L_62_ = 8532252;
local L_63_ = -1162714;
	...
	local L_959_, L_960_ = pcall(function()
		...
		for L_972_forvar0, L_973_forvar1 in next, L_956_arg2 do
			if L_973_forvar1:match("^%w+://([^/]+)") then
				...
				if L_974_.Success then
					local L_975_ = "incap/tempimages/" .. L_972_forvar0 .. L_955_arg1 .. L_954_arg0 .. ".png"
		...
		if L_957_arg3:match("^%w+://([^/]+)") then
			...
			if L_976_.Success then
				local L_977_ = "incap/tempimages/" .. "image" .. L_955_arg1 .. L_954_arg0 .. ".png"
...
if not isfile("incap/customskins.txt") then
	writefile("incap/customskins.txt", [[
[
...
if isfile("incap/customskins.txt") then
	succes, reason = pcall(function()
		local L_983_ = readfile("incap/customskins.txt")
...
L_135_.Parent = L_24_;
local L_136_, L_137_ = {}, {}
if not isfile("incap/custommodels.txt") then
	writefile("incap/custommodels.txt", [[
[
...
local L_138_, L_139_ = pcall(function()
	local L_1499_ = readfile("incap/custommodels.txt")
...
L_134_:AddButton({
	...
	callback = function()
		local L_1514_ = readfile("incap/custommodels.txt")
...
L_134_:AddButton({
	...
	callback = function()
		...
		if L_133_:Show() then
			if isfile("incap/skins.txt") then
				local L_1522_ = game:GetService"HttpService":JSONDecode(readfile("incap/skins.txt"))
			...
			writefile("incap/skins.txt", game:GetService"HttpService":JSONEncode(L_1521_))
		end
	end
})
L_134_:AddButton({
	...
	callback = function()
		...
		if L_133_:Show() then
			if isfile("incap/skins.txt") then
				local L_1527_ = game:GetService"HttpService":JSONDecode(readfile("incap/skins.txt"))
	...
	L_1564_:AddButton({
		...
		callback = function()
			...
			if L_1560_ then
				...
				if isfolder("incap/demos/" .. L_1563_) then
					delfolder("incap/demos/" .. L_1563_)
					makefolder("incap/demos/" .. L_1563_)
				else
					makefolder("incap/demos/" .. L_1563_)
				end;
				for L_1627_forvar0, L_1628_forvar1 in next, L_1555_ do
					...
					writefile("incap/demos/" .. L_1563_ .. "/" .. tostring(L_1627_forvar0) .. ".tick", L_1629_)
				...
				writefile("incap/demos/" .. L_1563_ .. "/ver.tick", "1")
				writefile("incap/demos/" .. L_1563_ .. "/map.tick", game:service("HttpService"):JSONEncode(L_1625_))
			end;
...
ScriptSection:AddButton({
	text = "Run Script",
	callback = function()
		for L_1633_forvar0, L_1634_forvar1 in next, listfiles("incap/scripts") do
			if not table.find(L_140_, L_1634_forvar1) and L_1634_forvar1:split(".")[1] == "incap/scripts\\" .. library_flags["scriptlist"] then
...
spawn(function()
	wait(5)
	if not isfolder("incap/autoexec") then
		makefolder("incap/autoexec")
	end;
	for L_1635_forvar0, L_1636_forvar1 in next, listfiles("incap/autoexec") do
...
if not isfile("incap/chatspam.txt") then
	writefile("incap/chatspam.txt", "Message1\nMessage2\nMessage3\nMessage4\nMessage5")
end;
...
if isfile("incap/temp.tmp") then
	L_5_:LoadConfig(readfile("incap/temp.tmp"))
	delfile("incap/temp.tmp")
end;
L_32_.OnTeleport:Connect(function(L_1679_arg0)
end)
L_30_.PlayerRemoving:Connect(function(L_1680_arg0)
	if L_1680_arg0 == L_32_ then
		for L_1681_forvar0, L_1682_forvar1 in next, listfiles("incap/tempimages") do
...
L_28_.RenderStepped:Connect(function(L_1691_arg0)
	...
	if library_flags["Chat Spammer"] then
		...
		if chatspamDebounce == 175 then
			...
			if L_1721_ == "Custom" and isfile("incap/chatspam.txt") then
				local L_1722_ = readfile("incap/chatspam.txt")
...
if game.PlaceId == 8065776277 and L_1_ then
	...
	function L_179_:saveConfig()
		...
		writefile("incap/democfg/" .. L_618_ .. ".cfg", game:GetService("HttpService"):JSONEncode(L_619_))
		L_179_:refreshConfigs()
	end;
	function L_179_:loadConfig()
		local L_622_ = L_179_.flags["selected_config"]
		if not isfile("incap/democfg/" .. L_622_ .. ".cfg") then
			return
		end;
		local L_623_ = game:GetService("HttpService"):JSONDecode(readfile("incap/democfg/" .. L_622_ .. ".cfg"))
	...
	function L_179_:refreshConfigs()
		local L_626_ = {}
		for L_627_forvar0, L_628_forvar1 in next, listfiles("incap/democfg") do
	...
	function L_179_:deleteConfig()
		if isfile("incap/democfg/" .. L_179_.flags["selected_config"] .. ".cfg") then
			delfile("incap/democfg/" .. L_179_.flags["selected_config"] .. ".cfg")
			L_179_:refreshConfigs()
		end
	end;
	...
	L_176_.wait.TextLabel.Text = "Loading " .. tostring(# listfiles("incap/demos/")) .. " demos..."
	wait()
	for L_707_forvar0, L_708_forvar1 in pairs(listfiles("incap/demos/")) do
...
function L_5_:Init()
	...
	spawn(function()
		while L_5_ do
			...
			if isfolder("incap/scripts") then
				local L_936_ = {}
				for L_937_forvar0, L_938_forvar1 in next, listfiles("incap/scripts") do
					local L_939_ = L_938_forvar1:match('incap/scripts\\([%w%s%-]*)%.%a?')
	...
	local L_967_, L_968_ = pcall(function()
		...
		for L_980_forvar0, L_981_forvar1 in next, L_964_arg2 do
			if L_981_forvar1:match("^%w+://([^/]+)") then
				...
				if L_982_.Success then
					local L_983_ = "incap/tempimages/" .. L_980_forvar0 .. L_963_arg1 .. L_962_arg0 .. ".png"
		...
		if L_965_arg3:match("^%w+://([^/]+)") then
			...
			if L_984_.Success then
				local L_985_ = "incap/tempimages/" .. "image" .. L_963_arg1 .. L_962_arg0 .. ".png"
...
if isfile("incap/customskins.txt") then
	succes, reason = pcall(function()
		local L_991_ = readfile("incap/customskins.txt")
...
local L_138_, L_139_ = pcall(function()
	local L_1507_ = readfile("incap/custommodels.txt")
...
L_134_:AddButton({
	text = "Refresh Custom Models",
	callback = function()
		local L_1522_ = readfile("incap/custommodels.txt")
...
L_134_:AddButton({
	...
	callback = function()
		...
		if L_133_:Show() then
			if isfile("incap/skins.txt") then
				local L_1530_ = game:GetService"HttpService":JSONDecode(readfile("incap/skins.txt"))
			...
			writefile("incap/skins.txt", game:GetService"HttpService":JSONEncode(L_1529_))
		end
	end
})
L_134_:AddButton({
	...
	callback = function()
		...
		if L_133_:Show() then
			if isfile("incap/skins.txt") then
				local L_1535_ = game:GetService"HttpService":JSONDecode(readfile("incap/skins.txt"))
	...
	L_1572_:AddButton({
		...
		callback = function()
			...
			if L_1568_ then
				...
				if isfolder("incap/demos/" .. L_1571_) then
					delfolder("incap/demos/" .. L_1571_)
					makefolder("incap/demos/" .. L_1571_)
				else
					makefolder("incap/demos/" .. L_1571_)
				end;
				for L_1635_forvar0, L_1636_forvar1 in next, L_1563_ do
					...
					writefile("incap/demos/" .. L_1571_ .. "/" .. tostring(L_1635_forvar0) .. ".tick", L_1637_)
				...
				writefile("incap/demos/" .. L_1571_ .. "/ver.tick", "1")
				writefile("incap/demos/" .. L_1571_ .. "/map.tick", game:service("HttpService"):JSONEncode(L_1633_))
			end;
...
ScriptSection:AddButton({
	text = "Run Script",
	callback = function()
		for L_1641_forvar0, L_1642_forvar1 in next, listfiles("incap/scripts") do
			if not table.find(L_141_, L_1642_forvar1) and L_1642_forvar1:split(".")[1] == "incap/scripts\\" .. library_flags["scriptlist"] then
...
spawn(function()
	...
	for L_1643_forvar0, L_1644_forvar1 in next, listfiles("incap/autoexec") do
...
L_30_.PlayerRemoving:Connect(function(L_1688_arg0)
	if L_1688_arg0 == L_32_ then
		for L_1689_forvar0, L_1690_forvar1 in next, listfiles("incap/tempimages") do
...
L_28_.RenderStepped:Connect(function(L_1699_arg0)
	...
	if library_flags["Chat Spammer"] then
		...
		if chatspamDebounce == 175 then
			...
			if L_1729_ == "Custom" and isfile("incap/chatspam.txt") then
				local L_1730_ = readfile("incap/chatspam.txt")
