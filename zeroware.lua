...
Elements.Window = UI:CreateWindow("zeroware", Vector2.new(492, 300), "none");

if game.PlaceId == 5400959086 then
    Elements.Watermark = UI:CreateWatermark("zero-ware | v1 | {game} | {fps}");
    ...
    Elements.Sections.UI = Elements.Tabs.Settings:CreateSector("UI", "Left"); do
        ...
        Elements.Toggles.ChangeName = Elements.Sections.UI:AddToggle("Change UI Name", false, function(t)
            if t then
                ...
                Elements.Window.NameLabel.Text = "zeroware";
            end;
        end, "Change-UI-Name");

        Elements.Textboxes.Name = Elements.Sections.UI:AddTextbox("Name", "zeroware", function(t)
